# LCA Collect - Shared Assembly Library

A shared library for assembly related components and pages.
This library contains components that can be used to deal with assemblies and EPDs.
